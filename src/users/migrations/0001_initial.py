    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[(1, 'Male'), (2, 'Female')], max_length=6, verbose_name='Пол')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Аватар')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(null=True, verbose_name='Страна')),
                ('city', models.CharField(null=True, verbose_name='Город')),
